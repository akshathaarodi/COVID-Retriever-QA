...
class CNNRetriever(Retriever):
    ...
    def __init__(self, bert_question_encoder, bert_paragraph_encoder, tokenizer, max_question_len,
        ...
        kernel_size = 3
        stride = 1
        self.conv1 = nn.Conv2d(input_channels, out_channel, kernel_size, stride)
        self.pool = nn.MaxPool2d(kernel_size, 3)
        self.conv2 = nn.Conv2d(6, 16 , kernel_size)
        
        self.fc1 = nn.Linear(16*59*84, 120)
        ...
        hidden_size = 75
        num_output = 1
        self.rnn = nn.LSTM(input_size=768, hidden_size=hidden_size, num_layers=2, dropout=0.5, batch_first=True, bidirectional=True)
    ...
    def forward(self, input_ids_question, attention_mask_question, token_type_ids_question,
        ...
        #print("Concat embs", concatenated_embs.shape)
        ...
        dense_out = self.fc(hidden)
        outs = self.act(dense_out)
        return outs.T
